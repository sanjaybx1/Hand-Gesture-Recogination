# 🤚 Hand Gesture Recognition to Voice Conversion

> **Real-time hand gesture detection that speaks what you sign — bridging the gap between sign language and voice communication.**
...
> *Add a screen recording or GIF of the project running here*
...
*"Technology should be accessible to everyone — this project is a small step towards that."* 🤝
